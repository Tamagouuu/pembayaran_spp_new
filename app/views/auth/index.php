                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Halaman Login<br><span class="font-weight-bold">BayarKuy</span></h1>
                                    </div>
                                    <?php Flasher::flash() ?>
                                    <form class="user" method="POST" action="<?= Helper::baseURL('/login/auth') ?>">
