...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <form class="user" action="<?= BASEURL . "/dashboard/storesiswa" ?>" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control form-control-user" placeholder="NIS" name="nis">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control form-control-user" placeholder="Telepon" name="telepon">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select name="pembayaran_id" class="custom-select" required>
                    ...
                    <?php foreach ($data['pembayaran'] as $p) : ?>
                        <option value="<?= $p['id'] ?>"><?= $p['tahun_ajaran'] ?> - <?= Helper::formatRupiah($p['nominal']) ?></option>
                    <?php endforeach ?>
                </select>
            </div>
